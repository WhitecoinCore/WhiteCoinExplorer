...
module.exports = {
  ...
  get_last_txs: function(count, min, cb) {
    Tx.find({'total': {$nin: [0,200000000,200010000,200020000,200030000,200040000,200050000,200030000,200110000,220000000,210000000,210020000,210010000,201000000]}}).sort({_id: 'desc'}).limit(count).exec(function(err, txs){
      if (err) {
        return cb(err);
      } else {
        return cb(txs);
  ...
  get_last_txs_reward: function(count, cb) {
    Tx.find({'total': {$in: [200000000,200010000,200020000,200030000,200040000,200050000,200030000,200110000,220000000,210000000,210020000,210010000,201000000]}}).sort({_id: 'desc'}).limit(count).exec(function(err, txs){
      if (err) {
        return cb(err);
      } else {
        return cb(txs);
